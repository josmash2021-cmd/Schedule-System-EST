...
const TITLES = { '/': 'Dashboard', '/trabajadores': 'Trabajadores', '/tareas': 'Tareas', '/equipo': 'Equipo', '/reparaciones': 'Reparaciones', '/ventas': 'Ventas', '/facturas': 'Facturas', '/inventario': 'Inventario', '/citas': 'Citas', '/ajustes': 'Ajustes' };
