...
const NAV = [
  ...
  { to: '/clientes', label: 'Clientes', icon: <><circle cx="9" cy="8" r="3.5" /><path d="M2.5 20v-1.5a5.5 5.5 0 0 1 11 0V20" /><path d="M16 5.5a3.5 3.5 0 0 1 0 5.83" /><path d="M17.5 13.6a5.5 5.5 0 0 1 4 4.9V20" /></> },
...
const TITLES = { '/': 'Dashboard', '/trabajadores': 'Trabajadores', '/tareas': 'Tareas', '/equipo': 'Equipo', '/reparaciones': 'Reparaciones', '/ventas': 'Ventas', '/facturas': 'Facturas', '/clientes': 'Clientes', '/ordenes': 'Órdenes', '/inventario': 'Inventario', '/citas': 'Citas', '/ajustes': 'Ajustes' };
