...
- `assets/img/logo-cruise.png`: logo con fondo transparente (410×193 tras
  ...
  (44px de alto, `.logo-desktop`) como en móvil (30px de alto,
...
- `assets/site.css`: sistema de diseño oscuro (tokens: `--black #000`,
  ...
  sólido en el top 28% y opacidad de la imagen a `.85` para que la parte
  superior se vea completamente oscura como en la referencia.
